...
namespace Stage.Players
{
    ...
    public class PlayerGuardState : IState
    {
        ...
        public void Enter()
        {
            ...
            _player.Collider.Weapon.SetColliderRole(ColliderRole.Parry);
        ...
        public void Exit()
        {
            ...
            _player.Collider.Weapon.SetColliderRole(ColliderRole.Weapon);
        }
        ...
        void SwitchColliderRole()
        {
            if (_elapsedTime > PlayerData.Data.ParryableTime)
                _player.Collider.Weapon.SetColliderRole(ColliderRole.Guard);
        }
